// Global variables
        ...
        function saveWord(e) {
            ...
            const wordData = {
                ...
                image: document.getElementById('wordImage').value.trim(),
            ...
            const wordExists = wordsData[category].some(word => word.title.toLowerCase() === wordTitle.toLowerCase());
            if (wordExists) {
                alert(`"${wordTitle}" already exists in the ${category} category!`);
                return;
            }
            ...
            alert(`"${wordTitle}" has been saved to ${formatCategoryName(category)} category!`);
                            ...
                            ${wordsData[category].map(word => `
                                <li class="word-item" data-category="${category}" data-title="${word.title}">
                                    ...
                                    <div class="word-actions">
                                        <button class="btn" onclick="viewWordDetail('${category}', '${word.title}')">View</button>
                                        <button class="btn btn-danger" onclick="deleteWord('${category}', '${word.title}')">Delete</button>
                                    </div>
                                </li>
                            `).join('')}
                        </ul>
        ...
        function submitMCTest() {
            ...
            resultContainer.innerHTML = `
                ...
                <button class="btn" onclick="retakeMCTest()">Retake Test</button>
                <button class="btn" onclick="backToMCQuestions()">Back to Questions</button>
            `;
        }
        ...
        function submitFillBlankTest() {
            ...
            resultContainer.innerHTML = `
                ...
                <button class="btn" onclick="retakeFillBlankTest()">Retake Test</button>
                <button class="btn" onclick="backToFillBlankQuestions()">Back to Questions</button>
            `;
        }
                ...
                testData.descriptive.map(q => `
                    <div class="question-item">
                        ...
                        <div class="test-actions">
                            <button class="btn btn-danger" onclick="deleteTestQuestion('descriptive', ${q.id})">Delete</button>
                        </div>
                    </div>
            ...
            mcList.innerHTML = testData.multipleChoice.length > 0 ? 
                testData.multipleChoice.map(q => `
                    <div class="question-item">
                        ...
                        <div class="test-actions">
                            <button class="btn btn-danger" onclick="deleteTestQuestion('multipleChoice', ${q.id})">Delete</button>
                            <button class="btn" onclick="startMCTest()">Start Test</button>
                        </div>
                    </div>
            ...
            fillBlankList.innerHTML = testData.fillBlank.length > 0 ? 
                testData.fillBlank.map(q => `
                    <div class="question-item">
                        ...
                        <p>Answer: ${q.answer}</p>
                        <div class="test-actions">
                            <button class="btn btn-danger" onclick="deleteTestQuestion('fillBlank', ${q.id})">Delete</button>
                            <button class="btn" onclick="startFillBlankTest()">Start Test</button>
                        </div>
                    </div>
        ...
        function loadProfile() {
            ...
            if (savedProfile) {
                ...
                document.getElementById('profileBirthMonth').value = profile.birthMonth || '1';
                document.getElementById('profileBirthDay').value = profile.birthDay || '';
                document.getElementById('profilePicture').src = profile.picture || 'https://via.placeholder.com/120';
            }
        }
